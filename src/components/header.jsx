...
<nav className="bg-white white:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b rounded-b-3xl">
  ...
  <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button type="button" className="text-white bg-gradient-to-br from-orange-400 to-orange-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium shadow-md rounded-3xl text-sm px-5 py-2.5 text-center me-2 mb-2 ">Order Now</button>
